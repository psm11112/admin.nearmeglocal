...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="formTitle">Cities</div>
        <div class="py-5">
<!--            <Breadcrumb :data="breadcrumbList"></Breadcrumb>-->
            <div class="relative overflow-x-auto rounded-lg shadow-lg  sm:rounded-lg p-5">
                ...
                <div class="flex justify-center" v-if="!form.processing && cities.data.length" >
                    <Table
                        :imageDisplay="true"
                        :svg="false"
                        :tableHeader="['','Name','States','Status','Action']"
                        :data="cities"
                        @showView="showView"
                        :deleteRoute="route('cities.deleted')"
                        :changeStatusRoute="route('cities.change-status')"
                        :userEditName="/cities/"
                        :view="true"
                    ></Table>
                ...
                <div class="flex justify-center p-5 " v-if="cities.data.length">
                    <Pagination :pages="cities" ></Pagination>
