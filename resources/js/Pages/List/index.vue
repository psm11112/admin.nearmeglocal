...
function showView(id){
    ...
    axios.get('/api/list/view/'+id).then((res)=>{
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-5">
            ...
            <div class="relative overflow-x-auto rounded-lg shadow-lg  sm:rounded-lg p-5">
                ...
                <div class="flex items-center justify-between  ">
                    <div class="p-5 sm:w-full">
                        ...
                        <div class="flex justify-between w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <div>
                                <Link :href="route('list.create')"    >
                                    <button class="formButton p-5" :disabled="form.processing" :class="form.processing?'cursor-not-allowed':''"> Add New List</button>
                                </Link>
                            </div>
                ...
                <div class="flex justify-center" v-if="!form.processing && list.data.length" >
                    <Table
                        :imageDisplay="true"
                        :svg="false"
                        :tableHeader="['','Title','Category','City','States','Country','Status', 'Active','']"
                        :data="list"
                        @showView="showView"
                        @addSubCategory="addSubCategory"
                        :deleteRoute="route('list.delete')"
                        :changeStatusRoute="route('list.change-status')"
                        :userEditName="/list/"
                        :multiList="false"
                        :view="false"
                    ></Table>
                ...
                <div class="flex justify-center p-5 " v-if="list.data.length">
                    <Pagination :pages="list" ></Pagination>
